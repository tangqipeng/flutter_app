...
import 'package:flutter_app/pullrefresh/pulluploadingmore.dart';
    ...
    return PopupMenuButton(
      ...
      itemBuilder: (BuildContext context){
        return <PopupMenuItem<String>>[
          PopupMenuItem(child: Text("pulldownrefresh_staggergridview"),value: "pulldown",),
          PopupMenuItem(child: Container(height: 1,color: Colors.grey,padding: EdgeInsets.all(0.0),margin: EdgeInsets.all(0.0),), height: 1,),
          PopupMenuItem(child: Text("pulluploadingmore"),value: "pullup",),
        ];
      },
